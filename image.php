...
                                printf( __( 'Published <span class="entry-date"><time class="entry-date" datetime="%1$s" pubdate>%2$s</time></span> at <a href="%3$s" title="Link to full-size image">%4$s &times; %5$s</a> in <a href="%6$s" title="Return to %7$s" rel="gallery">%7$s</a>', 'THEMENAME' ),
...
                                    $attachment_size = apply_filters( 'THEMENAME_attachment_size', array( 1200, 1200 ) ); // Filterable image size.
